...
const setActionEventListener = () => {
  window.addEventListener('onScreenRecordStateChange', screenRecordModuleAction);
};

const clearListener = () => {
  window.removeEventListener('onScreenRecordStateChange', screenRecordModuleAction);
};
