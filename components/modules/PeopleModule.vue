...
const setEventsListener = () => {
  ...
  window.addEventListener('onAdmissionRequest', eventHandlerRequestToAdmit);
  window.addEventListener('onAdmissionCancel', eventHandlerCancelForAdmit);
};
...
onUnmounted(() => {
  ...
  window.removeEventListener('onAdmissionRequest', eventHandlerRequestToAdmit);
  window.removeEventListener('onAdmissionCancel', eventHandlerCancelForAdmit);
});
